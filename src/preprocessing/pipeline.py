...
class PreprocessingPipeline:
    def __init__(self, slang_dict_path: str = None, emoji_dict_path: str = None, negation_dict_path: str = None):
    ...
    def process(self, text: str, for_training: bool = True) -> Tuple[str, Dict[str, Any]]:
        ...
        2. Split hashtags
        3. Map emojis to sentiment tokens & extract emoji polarity
        4. Normalize slang terms to standard semantic equivalents
        5. Apply negation scoping (attaching not_ prefix)
        Returns: (processed_text, metadata_dict)
        """
        if not text or not isinstance(text, str):
            return "", {"sarcasm_detected": False, "emoji_polarity": 0.0, "slang_polarity": 0.0}
        ...
        metadata = {
            ...
            "composite_polarity": emoji_polarity + slang_polarity
        }
